...
const Rentify = [
  "assets/Rentify/Rentify (1).png",
  "assets/Rentify/Rentify (2).png",
  "assets/Rentify/Rentify (3).png",
  "assets/Rentify/Rentify (4).png",
  "assets/Rentify/Rentify (5).png",
  "assets/Rentify/Rentify (6).png",
  "assets/Rentify/Rentify (7).png",
  "assets/Rentify/Rentify (8).png",
  "assets/Rentify/Rentify (9).png",
  "assets/Rentify/Rentify (10).png",
  "assets/Rentify/Rentify (11).png",
  "assets/Rentify/Rentify (12).png",
  "assets/Rentify/Rentify (13).png",
  "assets/Rentify/Rentify (14).png",
  "assets/Rentify/Rentify (15).png",
  "assets/Rentify/Rentify (16).png",
  "assets/Rentify/Rentify (17).png",
  "assets/Rentify/Rentify (18).png",
  "assets/Rentify/Rentify (19).png",
];
